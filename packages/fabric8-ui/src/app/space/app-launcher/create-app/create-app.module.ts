...
import { LauncherModule } from 'ngx-launcher';
...
@NgModule({
  imports: [CommonModule, CreateAppRoutingModule, FeatureFlagModule, FormsModule, LauncherModule],
  declarations: [CreateAppComponent],
  providers: [CheService, WorkspacesService],
})
