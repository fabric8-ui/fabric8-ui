...
describe('DeploymentsDonutChartComponent', (): void => {
  ...
  it('should not show mini text', (): void => {
    ...
    const text: DebugElement = testContext.fixture.debugElement.query(
      By.css('deployments-donut-chart-mini-text'),
    );
  ...
  describe('Mini chart', (): void => {
    ...
    xit('should show pods status', (): void => {
      const runningText: DebugElement = testContext.fixture.debugElement.query(
        By.css('#pod_status_Running'),
      );
      expect(runningText).toBeTruthy();
      expect(runningText.nativeElement.textContent.trim()).toBe('1 Running');

      const terminating: DebugElement = testContext.fixture.debugElement.query(
        By.css('#pod_status_Terminating'),
      );
    ...
    describe('Mini Idle chart', (): void => {
      ...
      xit('should show idled text', (): void => {
        ...
        const idle: DebugElement = testContext.fixture.debugElement.query(
          By.css('.deployments-donut-chart-mini-text'),
        );
