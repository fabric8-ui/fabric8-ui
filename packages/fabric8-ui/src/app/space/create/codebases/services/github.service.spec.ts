...
describe('Github: GitHubService', () => {
  ...
  it('Get repo commit status by URL and sha', (done: DoneFn) => {
    ghService
      .getRepoCommitStatusByUrl(
        'https://github.com/fabric8-services/fabric8-wit.git',
        '225368a414f88bd3c45fd686496a924a15ef81XX',
      )
      .pipe(first())
      .subscribe((data: any) => {
    ...
    controller
      .expectOne(
        'https://api.github.com/repos/fabric8-services/fabric8-wit/commits/225368a414f88bd3c45fd686496a924a15ef81XX',
      )
      .flush(expectedGitHubRepoCommit);
  });
  ...
  it('Get repo commit status by URL and sha in error', (done: DoneFn) => {
    ghService
      .getRepoCommitStatusByUrl(
        'https://github.com/fabric8-services/fabric8-wit.git',
        '225368a414f88bd3c45fd686496a924a15ef81YY',
      )
      .pipe(first())
      .subscribe(
        () => {
        ...
        (error) => {
          expect(error).toEqual(
            'Http failure response for https://api.github.com/repos/fabric8-services/fabric8-wit/commits/225368a414f88bd3c45fd686496a924a15ef81YY: 0 ',
          );
          controller.verify();
          done();
        },
    ...
    controller
      .expectOne(
        'https://api.github.com/repos/fabric8-services/fabric8-wit/commits/225368a414f88bd3c45fd686496a924a15ef81YY',
      )
  ...
  it('Get repo commit status by URL and sha with cached value', (done: DoneFn) => {
    ghService
      .getRepoCommitStatusByUrl(
        'https://github.com/fabric8-services/fabric8-wit.git',
        '225368a414f88bd3c45fd686496a924a15ef81b0',
      )
      .pipe(first())
      .subscribe((data: GitHubRepoCommit) => {
        expect(data.sha).toEqual(expectedGitHubRepoCommit.sha);
        const ghService: GitHubService = TestBed.get(GitHubService);
        const cachedValue: Observable<any> = ghService.getCache(
  ...
  it('Get repo details by full name', (done: DoneFn) => {
    ...
    controller
      .expectOne('https://api.github.com/repos/fabric8-services/fabric8-wit')
      .flush(expectedGitHubRepoDetails);
  });

  it('Get repo details by full name in error', (done: DoneFn) => {
    ghService.getRepoDetailsByFullName('fabric8-services/fabric8-wit').subscribe(
      () => {
        done.fail('Get repo details by full name in error');
      },
      (error) => {
        expect(error).toEqual(
          'Http failure response for https://api.github.com/repos/fabric8-services/fabric8-wit: 0 ',
        );
        controller.verify();
        done();
      },
  ...
  it('Get GitHub repo last commit for given URL', (done: DoneFn) => {
    ...
    controller
      .expectOne('https://api.github.com/repos/fabric8-services/fabric8-wit/git/refs/heads/master')
      .flush(expectedGitHubRepoCommit);
  });
  ...
  it('Get GitHub repo last commit for given URL in error', (done: DoneFn) => {
    ghService
      ...
      .subscribe(
        ...
        (error) => {
          expect(error).toEqual(
            'Http failure response for https://api.github.com/repos/fabric8-services/fabric8-wit/git/refs/heads/master: 0 ',
          );
          controller.verify();
          done();
        },
  ...
  it('Get GitHub repo license for given full name', (done: DoneFn) => {
    ...
    controller
      .expectOne('https://api.github.com/repos/fabric8-services/fabric8-wit/license')
      .flush(expectedGitHubRepoLicense);
  });

  it('Get GitHub repo license for given full name in error', (done: DoneFn) => {
    ghService.getRepoLicenseByName('fabric8-services/fabric8-wit').subscribe(
      () => {
        done.fail('Get GitHub repo license for given full name in error');
      },
      (error) => {
        expect(error).toEqual(
          'Http failure response for https://api.github.com/repos/fabric8-services/fabric8-wit/license: 0 ',
        );
        controller.verify();
        done();
      },
  ...
  it('Get GitHub repos associated with given user name in error', (done: DoneFn) => {
    ghService.getUserRepos('me').subscribe(
      () => {
        done.fail('Get GitHub repos associated with given user name in error');
      },
      (error) => {
        expect(error).toEqual(
          'Http failure response for https://api.github.com/users/me/repos: 0 ',
        );
        controller.verify();
        done();
      },
    ...
    controller
      .expectOne('https://api.github.com/users/me/repos')
      .error(new ErrorEvent('some error'));
  });
