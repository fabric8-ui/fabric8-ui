...
Fabric8-planner follows the guidelines listed in the link:https://uxd.fabric8.io/code-guidelines/ [HTML/CSS Code Guidelines], 
ensure that you use the same guidelines while contributing to the repository.
