...
const appPublic = fs.existsSync(resolveApp('public'))
  ? resolveApp('public')
...
module.exports = {
  ...
  appPublic,
  appHtml: path.resolve(appPublic, 'index.html'),
  appIndexJs: resolveApp(argv.appIndex || 'src/index.ts'),
...
if (fs.existsSync(resolveApp('packages'))) {
  module.exports.srcPaths.push(resolveApp('packages'));
}
