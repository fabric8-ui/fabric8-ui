...
describe('WorkspacesService', () => {
  ...
  describe('#createWorkspace', () => {
    it('should send Authorization header', function(done: DoneFn): void {
      ...
      const req: TestRequest = controller.expectOne('https://example.com/api/codebases/mockId/create');
    ...
    it('should return correct data', function(done: DoneFn): void {
      ...
      controller.expectOne('https://example.com/api/codebases/mockId/create').flush(expectedResponse);
    });
  });
  ...
  describe('#getWorkspaces', () => {
    it('should send Authorization header', function(done: DoneFn): void {
      ...
      const req: TestRequest = controller.expectOne('https://example.com/api/codebases/mockId/workspaces');
      expect(req.request.headers.get('Authorization')).toEqual('Bearer mock-auth-token');
      req.flush({});
    });
    ...
    it('should return correct data', function(done: DoneFn): void {
      ...
      controller.expectOne('https://example.com/api/codebases/mockId/workspaces').flush({ data: expectedResponse });
    });
  });
