...
export class NotificationService {
  ...
  constructor() {
    ...
    this.modes = [
      {info: { type: Notification.INFO, header: 'Info!', log: 'info'}},
      {success: { type: Notification.SUCCESS, header: 'Success!', log: 'info'}},
      {error: { type: Notification.DANGER, header: 'Error!', log: 'error'}},
      {warn: { type: Notification.WARNING, header: 'Warning!', log: 'warn'}}
    ];
