...
describe('List view component - ', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [DropdownModule, EmptyStateModule, FormsModule],
  ...
  it('should show the select checkbox by default', function () {
    let items = fixture.debugElement.queryAll(By.css('.list-group-item'));
  ...
  it('should add selected class to clicked list item', function () {
    let items = fixture.debugElement.queryAll(By.css('.list-view-pf-main-info'));
    let selectedItems = fixture.debugElement.queryAll(By.css('.active'));
  ...
  it('should handle double click event', function () {
    ...
    items[1].triggerEventHandler('dblclick', {});
  ...
  it('should respect the multiSelect setting', function () {
    ...
    items[2].triggerEventHandler('click', {});
    fixture.detectChanges();
    ...
    items[3].triggerEventHandler('click', {});
    fixture.detectChanges();
  ...
  it('should allow expanding rows', function () {
    ...
    let items = fixture.debugElement.queryAll(By.css('.list-view-pf-expand .fa-angle-right'));
