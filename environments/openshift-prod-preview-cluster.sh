...
export KUBERNETES_SERVICE_HOST=osoproxy.prod-preview.openshift.io
...
export FABRIC8_BUILD_TOOL_DETECTOR_API_URL="https://detector.api.prod-preview.openshift.io/api/"
